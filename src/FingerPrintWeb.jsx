...
debugger;
    ...
    SaveFingerPrint() {
        ...
        if (this.state.AFIS_FingerApllicationFingerModulty.fingerprintModality.fingerprints.length > 0) {
            ...
            if (this.props.onClickActionSave && this.props.onClickActionSave.canExecute) {

                this.props.onClickActionSave.execute();
            }
        } else {
    ...
    UpdateFingerPrint() {
        ...
        if (this.state.AFIS_FingerApllicationFingerModulty.fingerprintModality.fingerprints.length > 0) {
            ...
            if (this.props.onClickActionUpdate && this.props.onClickActionUpdate.canExecute) {

                this.props.onClickActionUpdate.execute();
            }
        } else {
            alert("يرجى اخذ البصمات اولا");
            return;
    ...
    DeleteFingerPrint() {
        ...
        if (this.props.onClickActionDelete && this.props.onClickActionDelete.canExecute) {

            this.props.onClickActionDelete.execute();
        }
    ...
    closePage() {
        ...
        if (this.props.onClickActionClosePage && this.props.onClickActionClosePage.canExecute) {

            this.props.onClickActionClosePage.execute();
        }
    ...
    ButtonVerfiyDeliverCapture() {
        ...
        if (this.state.AFIS_FingerApllicationFingerModulty.fingerprintModality.fingerprints.length > 0) {
            ...
            if (this.props.onClickActionVerify && this.props.onClickActionVerify.canExecute) {

                this.props.onClickActionVerify.execute();
            }
                                                        ...
                                                        if (ResponseImage.fingerprints.length > 0) {
                                                            for (var x = 0; x < ResponseImage.fingerprints.length; x++) {
                                                                if (ResponseImage.fingerprints[x].position == 'RightThumb') {
                                                                    ...
                                                                    debugger;
                                                                    this.props.ImageRightThumb.setValue(ResponseImage.fingerprints[x].image.dataBytes);

                                                                } else if (ResponseImage.fingerprints[x].position == 'LeftThumb') {
                                                                    //add image to attribute LeftImageThumb
                                                                    this.props.ImageLeftThumb.setValue(ResponseImage.fingerprints[x].image.dataBytes);
                                                        ...
                                                        if (ResponseImage.fingerprints.length > 0) {
                                                            ...
                                                            for (var x = 0; x < ResponseImage.fingerprints.length; x++) {
                                                                ...
                                                                if (ResponseImage.fingerprints[x].position == 'RightIndex') {
                                                                    this.props.ImageRightIndex.setValue(ResponseImage.fingerprints[x].image.dataBytes);
                                                                } else if (ResponseImage.fingerprints[x].position == 'RightMiddle') {
                                                                    this.props.ImageRightMiddle.setValue(ResponseImage.fingerprints[x].image.dataBytes);
                                                                } else if (ResponseImage.fingerprints[x].position == 'RightRing') {
                                                                    this.props.ImageRightRing.setValue(ResponseImage.fingerprints[x].image.dataBytes);
                                                                } else if (ResponseImage.fingerprints[x].position == 'RightLittle') {
                                                                    this.props.ImageRightLittle.setValue(ResponseImage.fingerprints[x].image.dataBytes);
                                                                }
                                                        ...
                                                        if (ResponseImage.fingerprints.length > 0) {
                                                            ...
                                                            for (var x = 0; x < ResponseImage.fingerprints.length; x++) {
                                                                ...
                                                                if (ResponseImage.fingerprints[x].position == 'LeftLittle') {
                                                                    this.props.ImageLeftLittle.setValue(ResponseImage.fingerprints[x].image.dataBytes);
                                                                } else if (ResponseImage.fingerprints[x].position == 'LeftRing') {
                                                                    this.props.ImageLeftRing.setValue(ResponseImage.fingerprints[x].image.dataBytes);
                                                                } else if (ResponseImage.fingerprints[x].position == 'LeftMiddle') {
                                                                    this.props.ImageLeftMiddle.setValue(ResponseImage.fingerprints[x].image.dataBytes);
                                                                } else if (ResponseImage.fingerprints[x].position == 'LeftIndex') {
                                                                    this.props.ImageLeftIndex.setValue(ResponseImage.fingerprints[x].image.dataBytes);
                                                                }
                    ...
                    <div className="container first-div" >
                        <div className="row">
                            <div className="col-xs-12 col-sm-12 col-md-12 header">
                                {/* <img src="./img/MyFirstModule$Images$IraqLogo.png" alt="horse" /> */}
                            </div>
                            <div className="col-xs-12 col-sm-12 col-md-12 content">
                                <div className="preview" style={{ position: "relative", bottom: "27px" }}>
                                    <div>


                                        <div className="expand">
                                            <div>
                                                <span id="statusInfo" style={{ display: "block", width: "500px", wordWrap: "break-word", fontSize: "24px" }}></span>
                    ...
                    <div className="container second-div">
                        <div className="row all-sides" style={{ position: "relative", bottom: "90px" }}>
                            <div className="col-md-4 left-side">
                                <div className="row" style={{ marginTop: '-100px', position: 'relative', left: '100px' }}>
                                    <div>
                                ...
                                <div className="row">
                                    <div id="IV01">
                                        ...
                                        <h2 className="text-uppercase">البصمات الملتقطة</h2>
                                        ...
                                        <div className="row">
                                            <div style={{ left: "20px", marginTop: "100%" }}>
                                                <input type="button" id="btnVerify" name="btnVerify" value="تحقق" onClick={() => this.ButtonVerfiyDeliverCapture()} style={{ visibility: this.props.EnableButtonVerify.value == 'false' ? "hidden" : "visible", width: '30%', backgroundColor: '#1f3646', color: 'white', margin: "5px" }} className="btn  btn-sm" />

                                                <input type="button" id="btnSave" name="btnSave" style={{ visibility: this.props.EnableButtonSave.value == 'false' ? "hidden" : "visible", width: '30%', backgroundColor: '#1f3646', color: 'white', margin: "5px" }} onClick={() => this.SaveFingerPrint()} className="btn  btn-sm" value="حفظ" />

                                                <input type="button" id="btnUpdate" name="btnSave" style={{ visibility: this.props.EnableButtonUpdate.value == 'false' ? "hidden" : "visible", width: '30%', backgroundColor: '#1f3646', color: 'white', margin: "5px" }} onClick={() => this.UpdateFingerPrint()} className="btn  btn-sm" value="تعديل" />

                                                <input type="button" id="btnDelete" name="btnSave" style={{ visibility: this.props.EnableButtonDelete.value == 'false' ? "hidden" : "visible", width: '30%', backgroundColor: '#1f3646', color: 'white', margin: "5px" }} onClick={() => this.DeleteFingerPrint()} className="btn  btn-sm" value="مسح" />

                                                <input type="button" id="btnClose" name="btnClose" style={{ width: '30%', backgroundColor: '#1f3646', color: 'white', margin: "5px" }} className="btn  btn-sm" onClick={() => this.closePage()} value="اغـلاق" />
                                            </div>
						...
						c-9.502,10.991-21.726,16.771-36.229,17.738c-0.771,0.051-1.525,0.364-2.287,0.555C97.852,231.999,95.932,231.999,94.012,231.999z" />
                                                    ...
                                                    <ul className="lefhandlist">
                                                        ...
                                                        <li className="pinkyFingerLeft" style={{ background: '#ffe0bd' }} > <input type="checkbox" onChange={() => this.setState({
                                                            LittleLeft: !this.state.LittleLeft
                                                        })} checked={this.state.LittleLeft} title="الخنصر - اليد اليسرى" value="0"></input></li>
                                                        {/* onchange="ChnageCheckRadio(this)" */}
                                                        <li className="ringFingerLeft" style={{ background: '#ffe0bd' }}><input type="checkbox" onChange={() => this.setState({
                                                            RingLeft: !this.state.RingLeft
                                                        })} checked={this.state.RingLeft} title="البنصر - اليد اليسرى" value="1"></input></li>
                                                        {/* onchange="ChnageCheckRadio(this)"  */}
                                                        <li className="middleFingerLeft" style={{ background: '#ffe0bd' }}><input type="checkbox" onChange={() => this.setState({
                                                            MiddleLeft: !this.state.MiddleLeft
                                                        })} checked={this.state.MiddleLeft} title="الوسطى - اليد اليسرى" value="2"></input></li>
                                                        {/* onchange="ChnageCheckRadio(this)" */}
                                                        <li className="indexFingerLeft" style={{ background: '#ffe0bd' }}><input type="checkbox" onChange={() => this.setState({
                                                            IndexLeft: !this.state.IndexLeft
                                                        })} checked={this.state.IndexLeft} title="السبابة - اليد اليسرى" value="3"></input></li>
                                                        {/* onchange="ChnageCheckRadio(this)" */}
                                                        <li className="thumbFingerLeft" style={{ background: '#ffe0bd' }}><input type="checkbox" onChange={() => this.setState({
						...
						c-7.585,2.905-15.517,4.226-23.511,5.29c-2.908,0.388-5.821,0.745-8.732,1.116C110.413,231.999,108.493,231.999,106.573,231.996z" />
                                                    ...
                                                    <ul className="righthandlist">
                                                        {/* onchange="ChnageCheckRadio(this)" */}
                                                        <li className="thumbFingerRight" style={{ background: '#ffe0bd' }}><input type="checkbox" onChange={() => this.setState({
                                                            ThumbRight: !this.state.ThumbRight
                                                        })} checked={this.state.ThumbRight} title="الإبهام - اليد اليمنى" value="5"></input></li>
                                                        {/* onchange="ChnageCheckRadio(this)" */}
                                                        <li className="indexFingerRight" style={{ background: '#ffe0bd' }}><input type="checkbox" onChange={() => this.setState({
                                                            IndexRight: !this.state.IndexRight
                                                        })} checked={this.state.IndexRight} title="السبابة - اليد اليمنى" value="6"></input></li>
                                                        {/* onchange="ChnageCheckRadio(this)" */}
                                                        <li className="middleFingerRight" style={{ background: '#ffe0bd' }}><input type="checkbox" onChange={() => this.setState({
                                                            MiddleRight: !this.state.MiddleRight
                                                        })} checked={this.state.MiddleRight} title="الوسطى - اليد اليمنى" value="7"></input></li>
                                                        {/* onchange="ChnageCheckRadio(this)" */}
                                                        <li className="ringFingerRight" style={{ background: '#ffe0bd' }}><input type="checkbox" onChange={() => this.setState({
                                                            RingRight: !this.state.RingRight
                                                        })} checked={this.state.RingRight} title="البنصر - اليد اليمنى" value="8"></input></li>
                                                        {/* onchange="ChnageCheckRadio(this)" */}
                                                        <li className="pinkyFingerRight" style={{ background: '#ffe0bd' }}><input type="checkbox" onChange={() => this.setState({
